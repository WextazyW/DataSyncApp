package com.example.DataSyncApp.screens.favorite
...
import com.example.moviesapp.screens.favorite.FavoriteFragment
...
class FavoriteAdapter : RecyclerView.Adapter<FavoriteAdapter.StartViewHolder>() {
    ...
    override fun onViewAttachedToWindow(holder: StartViewHolder) {
        ...
        holder.itemView.setOnClickListener {
            FavoriteFragment.clickMovie(listStart[holder.adapterPosition])
        }
    }
